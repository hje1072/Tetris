...
public class Mino {
	...
	public void checkMovementCollision() {
		...
		int leftWall = PlayManager.left_x;
		int rightWall = PlayManager.right_x;
		int bottomFloor = PlayManager.bottom_y;
	...
	public void checkStaticBlockCollision() { //쌓은블록확인용
		...
		ArrayList<Block> staticBlocks = PlayManager.staticBlocks;
	...
	public void handling() {
		...
		boolean TURN = KeyHandler.turnPressed;
	...
	public void update() {
		boolean SKILL = KeyHandler.skillPressed;
